...
k8s_master_mgtip=${k8s_master_mgtip:-100.123.35.1}
read -p "k8s-worker1 mgt ip [100.123.35.2]: " k8s_worker1_mgtip
k8s_worker1_mgtip=${k8s_worker1_mgtip:-100.123.35.2}
read -p "k8s-worker2 mgt ip [100.123.35.3]: " k8s_worker2_mgtip
k8s_worker2_mgtip=${k8s_worker2_mgtip:-100.123.35.3}
read -p "k8s-worker3 mgt ip [100.123.35.4]: " k8s_worker3_mgtip
k8s_worker3_mgtip=${k8s_worker3_mgtip:-100.123.35.4}
echo
